package com.example.guardiancamera_wifi.test;
...
public class RtmpTestActivity extends AppCompatActivity
        implements ConnectCheckerRtmp, View.OnClickListener, SurfaceHolder.Callback,
        View.OnTouchListener {

    private String streamUrl = "rtmp://49.50.172.17:8080/app/stream";
    ...
    public void onConnectionSuccessRtmp() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(RtmpTestActivity.this, "Connection success", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onConnectionFailedRtmp(final String reason) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(RtmpTestActivity.this, "Connection failed. " + reason, Toast.LENGTH_SHORT)
                        .show();
    ...
    public void onDisconnectRtmp() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(RtmpTestActivity.this, "Disconnected", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onAuthErrorRtmp() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(RtmpTestActivity.this, "Auth error", Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public void onAuthSuccessRtmp() {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(RtmpTestActivity.this, "Auth success", Toast.LENGTH_SHORT).show();
            }
        });
    }
