package com.example.guardiancamera_wifi.presenters;
...
import com.example.guardiancamera_wifi.libs.Types;
import com.example.guardiancamera_wifi.views.activities.MainMenuActivity;
...
public class LoginPresenter {
    ...
    public void initOAuthModules() {
        ...
        GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                .requestIdToken("494240878735-c8eo6b0m0t8fhd8vo2lcj0a9v6ena7bp.apps.googleusercontent.com")
                .requestEmail()
                .build();
    ...
    public void mainServerAuth(String username, String password) throws IOException {
        ...
        try {
            ...
            /* Disallocate credentials from memory */
            username = null;
            password = null;
            System.gc();
